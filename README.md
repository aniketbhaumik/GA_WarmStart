...
Key Features
  ...
  2. Warm-start GA using a mix of top_k and mid_k predicted individuals.
...
1. GA population is randomly initialized; set random seeds for deterministic runs.

2. Hyperparameters (e.g., population size, selection ratio) can be tuned in notebook cells.

3. Ablation studies for different sequence lengths and top-k configurations included.
